...
import { coordinatorHeader } from '../../../store/tableStore';
...
class ListCoordinators extends Component{
    constructor(props){
        super(props);
...
export default withStyles(styles)(ListCoordinators);